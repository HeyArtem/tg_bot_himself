В проекте пишу tg bot.
Выводится клавиатура, отвечает на команды, выводится инлайн клавиатура, машина состояний.
Перед запуском вписать:
-свой id (data/config.py)
-BOT_TOKEN (.env)
